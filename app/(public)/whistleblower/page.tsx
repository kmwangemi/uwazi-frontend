...
import {
  whistleblowerFormSchema,
  type WhistleblowerFormData,
        ...
        <div className='mx-auto max-w-2xl'>
          <Card className='p-8 text-center'>
            ...
            <p className='mt-2 text-gray-600'>
              Your anonymous report has been securely submitted and is now under
              review.
            </p>
            ...
            <div className='mt-8 rounded-lg bg-gray-50 p-6'>
              ...
              <p className='mt-3 text-sm text-gray-600'>
                Save this ID to check the status of your report at any time. Do
            ...
            <div className='mt-8 text-left'>
              ...
              <ol className='mt-4 space-y-3 text-sm text-gray-600'>
                <li className='flex gap-3'>
                  <span className='flex-shrink-0 inline-flex h-6 w-6 items-center justify-center rounded-full bg-primary text-white text-xs font-semibold'>
                    1
                  </span>
                  <span>
          ...
          <div className='flex gap-3 sm:gap-4'>
            ...
            <div>
              ...
              <p className='mt-1 text-sm text-green-800'>
                All reports are encrypted and confidential. We do not collect IP
                addresses or device identifiers. You are legally protected as a
                whistleblower.
              </p>
            </div>
          </div>
        ...
        <Card className='p-8'>
          <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
            ...
            <div>
              ...
              />
              <p className='mt-1 text-xs text-gray-600'>
                Will only be used to contact you securely about your report
              </p>
            </div>
            ...
            <Card className='border-orange-200 bg-orange-50 p-4'>
              <div className='flex gap-3'>
                ...
                <div className='text-sm text-orange-800'>
                  ...
                  <p className='mt-1'>
                    Please ensure all information provided is factual to the
                    best of your knowledge. False reports may have legal
                    consequences.
                  </p>
                </div>
              </div>
        ...
        <Card className='mt-8 p-8'>
          ...
          <div className='space-y-4 text-sm text-gray-700'>
            ...
            <div>
              ...
              <p className='mt-2'>
                You are protected under the Whistleblower Protection Act.
