...
export default function AvailableTendersPage() {
  ...
  const filteredTenders = useMemo(() => {
    ...
    if (sortBy === 'deadline') {
      ...
      result = result.sort((a, b) => b.budgetedAmount - a.budgetedAmount);
  ...
  return (
    <div className='min-h-screen bg-background'>
      {/* Hero Section */}
      <div className='bg-gradient-to-r from-primary to-primary/80 text-white py-12 px-4 -mx-4 mb-8'>
              ...
              {paginatedTenders.map(tender => {
                ...
                return (
                  <Card
                    ...
                    onClick={() =>
                      router.push(`/supplier/tenders/${tender.id}`)
                    }
                  >
                    {/* Header */}
                    ...
                    <Button
                      ...
                      onClick={e => {
                        e.stopPropagation();
                        router.push(`/supplier/tenders/${tender.id}/bid`);
                      }}
                    >
