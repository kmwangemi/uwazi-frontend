...
export default function BidDetailPage() {
  ...
  const totalScore =
    (technicalScore + financialScore + complianceScore + performanceScore) / 4;
      ...
      <div className='flex justify-between items-start'>
        <div>
          ...
          <p className='text-gray-600 mt-1'>
            BuildTech Solutions - Tender TND/2024/001
          </p>
        </div>
          ...
          <Card className='p-6'>
            ...
            <div className='space-y-6'>
              ...
              <div>
                ...
                />
                <p className='text-xs text-gray-600 mt-1'>
                  Evaluate: turnover, cash flow, bank references, ability to
                  fund
                </p>
              </div>
              {/* Compliance Score */}
              <div>
                ...
                />
                <p className='text-xs text-gray-600 mt-1'>
                  Evaluate: required documents, certifications, compliance with
                  requirements
                </p>
              </div>
              {/* Performance Score */}
              <div>
                ...
                />
                <p className='text-xs text-gray-600 mt-1'>
                  Evaluate: on-time delivery, quality, customer satisfaction,
                  disputes
                </p>
              </div>
              {/* Overall Score */}
              ...
              {[
                {
                  ...
                  actor: 'BuildTech Solutions',
                  time: 'Jan 10, 2024 10:30 AM',
                  icon: FileText,
                },
                {
                  action: 'Under Evaluation',
                  actor: 'John Omondi (Evaluator)',
                  time: 'Jan 10, 2024 11:15 AM',
                  icon: Clock,
                },
                {
                  action: 'Documents Verified',
                  actor: 'System Auto-Check',
                  time: 'Jan 10, 2024 11:20 AM',
                  icon: CheckCircle,
                },
              ].map((log, idx) => (
                <div
