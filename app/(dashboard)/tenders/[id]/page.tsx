...
export default function TenderDetailPage({ params }: { params: { id: string } }) {
  ...
  const tender = mockTenders.find((t) => t.id === params.id)
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="text-right">
            <p className="text-3xl font-bold text-gray-900">{formatCurrency(tender.budgetedAmount)}</p>
        ...
        {tender.corruptionRisk >= 70 && (
          <Alert className="border-red-200 bg-red-50">
            ...
            <AlertDescription className="text-red-800">
              This tender has a high corruption risk score ({tender.corruptionRisk}). Additional scrutiny recommended.
            </AlertDescription>
          </Alert>
        )}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="p-4">
          ...
          <p className="text-lg font-semibold mt-2">{formatDate(new Date(tender.postedDate))}</p>
        </Card>
        <Card className="p-4">
          <p className="text-sm text-gray-600">Deadline</p>
          <p className="text-lg font-semibold mt-2">{formatDate(new Date(tender.deadline))}</p>
        </Card>
        <Card className="p-4">
          <p className="text-sm text-gray-600">Procuring Entity</p>
          <p className="text-lg font-semibold mt-2 line-clamp-2">{tender.procuringEntity}</p>
        </Card>
      </div>
          ...
          <TabsContent value="details" className="space-y-4">
            <div className="grid grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-gray-700 bg-gray-50 px-3 py-2 rounded-md inline-block">{tender.category}</p>
              </div>
              <div>
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Tender Type</h3>
                <p className="text-gray-700">{tender.type}</p>
              </div>
            </div>
          </TabsContent>
          ...
          <TabsContent value="analysis" className="space-y-4">
            <div className="space-y-4">
              <div className="space-y-2">
                <h3 className="font-semibold text-gray-900">Red Flags Detected</h3>
              ...
              <div className="space-y-2">
                ...
                <ul className="space-y-2">
                  <li className="text-sm text-gray-700">• Budget significantly higher than similar tenders</li>
                  <li className="text-sm text-gray-700">• Short deadline for submissions</li>
                  <li className="text-sm text-gray-700">• Limited number of potential bidders</li>
                </ul>
              </div>
            </div>
          </TabsContent>
            ...
            <div className="space-y-2">
              <div className="border border-gray-200 rounded-md p-3 flex items-center justify-between hover:bg-gray-50">
                <div className="text-sm">
                  <p className="font-medium text-gray-900">Tender Document.pdf</p>
              ...
              <div className="border border-gray-200 rounded-md p-3 flex items-center justify-between hover:bg-gray-50">
                <div className="text-sm">
                  <p className="font-medium text-gray-900">Specifications.xlsx</p>
          ...
          <TabsContent value="history" className="space-y-4">
            <div className="space-y-3">
              <div className="border-l-2 border-blue-500 pl-4 py-2">
                ...
                <p className="text-sm text-gray-600">{formatDate(new Date(tender.postedDate))}</p>
              </div>
              <div className="border-l-2 border-gray-300 pl-4 py-2">
                <p className="font-medium text-gray-900">Status Updated to: Under Review</p>
