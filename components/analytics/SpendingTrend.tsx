  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      <LineChart data={chartData}>
        ...
        />
        <Legend />
        <Line type="monotone" dataKey="budgeted" stroke="#64748b" strokeWidth={2} name="Budgeted (M)" />
        <Line type="monotone" dataKey="actual" stroke="#00ff88" strokeWidth={2} name="Actual (M)" />
        <Line type="monotone" dataKey="flagged" stroke="#ef4444" strokeWidth={2} name="Flagged (M)" />
      </LineChart>
    </ResponsiveContainer>
  )
}
